...
div.a{
  ...
  <div class="row">
    <div class="column">
      <div class="card">
        <img src="assets/img/Adhisti_Roshandy.jpeg" alt="Jane" style="width:100%">
        <div class="container">
          <h3>Adhisti Roshandy</h3>
          <p class="titlecard">Students from CCIT-FTUI</p>
          <p>adhistiroshandy808@gmail.com</p>
          <a href="mailto:adhistiroshandy808@gmail.com"><p><button class="button">Contact Us</button></p></a>
        </div>
      </div>
    </div>
    ...
    <div class="column">
      <div class="card">
        ...
        <div class="container">
          <h3>Fahmi Alamsyah Nugroho</h3>
          <p class="titlecard">Students from CCIT-FTUI</p>
          <p>alamsyahfahmi99@gmail.com</p>
          <a href="mailto:alamsyahfahmi99@gmail.com"><p><button class="button">Contact Us</button></p></a>
        </div>
      </div>
    </div>
    ...
    <div class="column">
      <div class="card">
        <img src="assets/img/Restuaji_Eliansyah.jpeg" alt="John" style="width:100%">
        <div class="container">
          <h3>Restuaji Eliansyah</h3>
          <p class="titlecard">Students from CCIT-FTUI</p>
          <p>restuaerestu291@gmail.com</p>
          <a href="mailto:restuaerestu291@gmail.com"><p><button class="button">Contact Us</button></p></a>
        </div>
      </div>
    </div>
  </div>
