...
<div class="contact" id="contact">
  <div class="container">
    <div style="text-align:center">
      <h2 style="font-size: 50px;"><b>Donation</b></h2>
      <p>Fundraising is but a tool to achieve a collaborative dream.</p>
    </div>
    <div class="row">
      <div class="column">
        <img src="assets/img/donation.png" style="width:100%">
      </div>
      <div class="column">
        <form class="form-group" style="padding:20px" action="User?proses=donate" method="post">
          ...
          <label for="E-mail">Amount</label>
          <input type="text" id="femail" name="amount"placeholder="Amount (Rp)" required>
          <div class="valid-feedback">Looks good!</div>
          <div class="invalid-feedback">
            Please provide a valid Email.
          </div>
          ...
          <textarea id="Massage" name="message" placeholder="Add some Massage" style="height:170px" required></textarea>
          <div class="valid-feedback">Looks good!</div>
          <div class="invalid-feedback">
            Please provide a valid Email.
          </div>
